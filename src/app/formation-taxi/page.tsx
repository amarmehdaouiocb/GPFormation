...
export default async function Page() {
  ...
  return <FormationFamilyTemplate title="Formation TAXI" subtitle="Devenez chauffeur de TAXI avec le premier centre de formation agréé d'Île-de-France." content={content} subFormations={subFormations} breadcrumbs={breadcrumbs} heroImage="/images/taxi-parisien.jpg" />;
}
