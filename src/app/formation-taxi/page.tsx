...
export default async function Page() {
  ...
  return <FormationFamilyTemplate title="Formation TAXI" subtitle="Devenez chauffeur de TAXI avec notre centre de formation." content={content} subFormations={subFormations} breadcrumbs={breadcrumbs} heroImage="/images/taxi-parisien.jpg" />;
}
