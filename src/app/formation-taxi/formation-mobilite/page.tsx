...
export default async function Page() {
  ...
  return <FormationDetailTemplate title={data.title || "Programme"} content={content} breadcrumbs={breadcrumbs} duration="14 heures ou 35 heures" certification="Attestation de suivi" tag="TAXI" heroImage={`${GENERATED_IMAGE_BASE}/taxi-hero-practical-training.webp`} photos={[`${GENERATED_IMAGE_BASE}/driver-training-navigation.webp`, `${GENERATED_IMAGE_BASE}/taxi-hero-practical-training.webp`, `${GENERATED_IMAGE_BASE}/reussite-carte-professionnelle.webp`]} />;
}
