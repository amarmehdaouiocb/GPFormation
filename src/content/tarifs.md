...
La formation qui s'adapte à votre rythme
**990€**

- Une application mobile disponible sur App Store & Play Store
- 60 jours d'accès en ligne
- Support de cours PDF + Vidéos
...
## FORMATIONS SPÉCIFIQUES TAXI

### Formation continue TAXI

Renouvellement de la carte Taxi obligatoire tous les 5 ans
**250€**
...
- 14 heures répartis sur 2 jours
- Connaissance de la clientèle (07h00)
- Geste et posture (07h00)
...
Pour les chauffeurs VTC souhaitant obtenir la carte de Taxi
**750€**

- 3 jours de formation
- Module 1 : F(T) — Réglementation Locale et Connaissances du Territoire
- Module 2 : G(T) Réglementation Nationale spécifique
- 4 cours pratique (véhicule équipé double commande + mise à disposition le jour de l'examen)

---

## FORMATIONS SPÉCIFIQUES VTC

### Formation continue VTC

Renouvellement de la carte VTC obligatoire tous les 5 ans
**180€**
...
- Module 2 : G(V) Réglementation Nationale spécifique
- 4 cours pratique (véhicule équipé double commande + mise à disposition le jour de l'examen)
...
Pour toutes personnes souhaitant se perfectionner en anglais
**950€**
