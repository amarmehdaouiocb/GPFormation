...
**FORMATION RS5637 :** Habilitation pour l'accès à la profession de conducteur de voiture de transport avec chauffeur (VTC).

## Épreuves théoriques d'admissibilité

### 5 épreuves théoriques « Tronc Commun »

- A — Réglementation du transport public particulier de personnes (coefficient 3, note éliminatoire inférieure à 6/20)
- B — Gestion (coefficient 2, note éliminatoire inférieure à 6/20)
- C — Sécurité routière (coefficient 3, note éliminatoire inférieure à 6/20)
- D — Capacité d'expression et de compréhension en langue française, sur la base d'un texte de 15 à 20 lignes (coefficient 2, note éliminatoire inférieure à 6/20)
- E — Capacité d'expression et de compréhension en langue anglaise (coefficient 1, note éliminatoire inférieure à 4/20)

### 2 épreuves spécifiques d'admissibilité (VTC)

- F(V) Développement Commercial (coefficient 3, note éliminatoire inférieure à 6/20)
- G(V) Réglementation nationale VTC ainsi que sur la gestion propre à l'activité (coefficient 3, note éliminatoire inférieure à 6/20)

**Méthode d'évaluation :** QCM et QRC

**Seuil d'admissibilité :** 10/20 (sans note éliminatoire) valable pour 3 présentations à l'épreuve pratique dans un délai de 1 an.
...
Mise en situation pratique de réalisation d'une course de VTC.
...
Préparation à la réussite de l'examen de chauffeur de VTC.
